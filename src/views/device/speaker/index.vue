    ...
    <Card>
      ...
      <div class="table-toolbar">
        <Space>
          ...
          <Button @click="handleTest">播报测试</Button>
        </Space>
      </div>
...
import { Card, Table, Form, FormItem, Input, Select, SelectOption, Button, Space, Tag, Modal } from 'ant-design-vue';
...
async function fetchData() {
  ...
  try {
    dataSource.value = [
      { id: 1, deviceNo: 'SPK20240001', batchNo: 'BATCH001', factory: '厂商A', mchNo: 'M10001', mchName: '测试商户001', agentName: '代理商A', status: 1, statusName: '在线', createdAt: '2024-01-01 10:00:00' },
      { id: 2, deviceNo: 'SPK20240002', batchNo: 'BATCH001', factory: '厂商A', mchNo: '', mchName: '未绑定', agentName: '代理商A', status: 1, statusName: '在线', createdAt: '2024-01-01 10:00:00' },
      { id: 3, deviceNo: 'SPK20240003', batchNo: 'BATCH002', factory: '厂商B', mchNo: 'M10002', mchName: '测试商户002', agentName: '代理商B', status: 0, statusName: '离线', createdAt: '2024-01-02 14:30:00' },
    ];
...
function handleTest() { message.info('播报测试功能开发中'); }
