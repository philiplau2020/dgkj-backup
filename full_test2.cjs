...
async function fullTest() {
    ...
    return new Promise((resolve, reject) => {
        conn.on('ready', async () => {
            ...
            const apis = [
                // 系统管理
                ['[系统] 用户列表', '/basic-api/sys/user/list'],
                ['[系统] 角色列表', '/basic-api/sys/role/list'],
                ['[系统] 菜单列表', '/basic-api/sys/menu/list'],
                ['[系统] 部门列表', '/basic-api/sys/dept/list'],
                ['[系统] 字典列表', '/basic-api/sys/dict/list'],
                ['[系统] 配置列表', '/basic-api/sys/config/list'],
                ['[系统] 日志列表', '/basic-api/sys/log/list'],
                ['[系统] 通知列表', '/basic-api/sys/notice/list'],
                // 运维监控
                ...
                ['[中信] 资金归集', '/basic-api/citic/collection/list'],
                ['[中信] 余额分账', '/basic-api/citic/profit-share/list'],
                ...
                ['[通道] 通道池列表', '/basic-api/pool/channel/list'],
                // 商户管理
                ['[商户] 商户列表', '/basic-api/merchant/list'],
                ['[商户] 应用列表', '/basic-api/mch/app/list'],
                ['[商户] 门店列表', '/basic-api/mch/store/list'],
                // 代理管理
                ...
                // 对账管理
                ['[对账] 对账批次', '/basic-api/check/batch/list'],
                // 分润管理
                ['[分润] 分润记录', '/basic-api/profit/record/list'],
                // 统计
            ...
            console.log('\n' + '='.repeat(60));
            console.log(`结果: ✓ ${pass} 个通过, ✗ ${fail} 个失败`);
            console.log('='.repeat(60));
